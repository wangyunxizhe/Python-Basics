...
# 第一页
slide1 = prs.slides.add_slide(prs.slide_layouts[0])  # 选择第一种幻灯片布局样式
slide1.shapes.title.text = "4S店汽车消费者洞察报告"
slide1.shapes.placeholders[1].text = "2020年第一季度"
# 第二页
slide2 = prs.slides.add_slide(prs.slide_layouts[1])  # 选择第二种幻灯片布局样式
...
# 第三页
slide3 = prs.slides.add_slide(prs.slide_layouts[1])  # 选择第二种幻灯片布局样式
...
# 第四页
slide4 = prs.slides.add_slide(prs.slide_layouts[1])  # 选择第二种幻灯片布局样式
...
p3.font.size = Pt(35)
# 第五页
slide5 = prs.slides.add_slide(prs.slide_layouts[1])  # 选择第二种幻灯片布局样式
slide5.shapes.title.text = "汽车消费者用户画像"
# 图表1
chart_data = CategoryChartData()
chart_data.categories = ['70后', '80后', '90后']
chart_data.add_series('各年龄段平均购车花费', (40, 45, 25))
slide5.shapes.add_chart(XL_CHART_TYPE.COLUMN_CLUSTERED, Inches(1), Inches(2.5), Inches(4), Inches(3), chart_data)
# 图表2
chart_data1 = CategoryChartData()
chart_data1.categories = ['男', '女']
chart_data1.add_series('性别分布', (65, 35))
chart = slide5.shapes.add_chart(XL_CHART_TYPE.PIE, Inches(6), Inches(2.5), Inches(3), Inches(3), chart_data).chart
...
prs.save("../../resources/pptProject.pptx")